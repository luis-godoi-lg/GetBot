...
namespace GestaoChamados.Data
{
    ...
    /// Define as entidades (Usuários, Chamados, Mensagens de Chat) e suas configurações no banco de dados
    /// </summary>
    public class ApplicationDbContext : DbContext
    {
        ...
        /// <summary>
        /// Tabela de usuários do sistema (Cliente, Técnico, Gerente, Admin)
        /// </summary>
        ...
        /// <summary>
        /// Tabela de mensagens de chat entre clientes e técnicos
        /// </summary>
